...
export const Request = (resource, operation) => ({
  type: `${toUpper(resource)}_REQUEST`,
});
...
export const Succeed = (resource) => (data, operation) => ({
  type: `${toUpper(operation)}_${toUpper(resource)}`,
  payload: {
    data,
  },
});
...
export const Failure = (error, resource, operation) => ({
  type: `${toUpper(resource)}_FAILURE`,
  payload: {
    error,
  },
});

export const Fail = (resource) => (error, operation) => ({
  type: `${toUpper(resource)}_FAILURE`,
  payload: {
    error,
  },
